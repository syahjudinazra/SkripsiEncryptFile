...
<head>
  ...
  <title>TA Syahjuddin Azra</title>
  <meta name="description" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- favicon
		============================================ -->
  <link rel="shortcut icon" type="image/x-icon" href="img/logo/logobl.png">
  <!-- Google Fonts
		============================================ -->
  ...
  <div class="left-sidebar-pro">
    <nav id="sidebar" class="">
      <div class="sidebar-header">
        <a href="index.html"><img class="main-logo" src="img/logo/horizontallogo.png" width="173px" height="46px" style="margin-top: 10px;" alt="" /></a>
        <strong><img src="img/logo/logobl.png" alt=""></strong>
      </div>
      <div class="nalika-profile">
        <div class="profile-dtl">
          <a href="#"><img src="img/logo/azra.jpg" alt="" /></a>
